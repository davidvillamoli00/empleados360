...
<head>
    ...
    <title>Sistema CRUD de Empleados en PHP utilizando PDO y MySQL</title>
...
<body>
    ...
    <h1 class="text-center mt-5 mb-5 fw-bold">Sistema CRUD de Empleados en PHP utilizando PDO y MySQL</h1>
        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-8">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">DNI (NIE): <strong><?php echo $dataInfo['cedula']; ?></strong></li>
                    ...
                    <li class="list-group-item">Numero movil: <strong><?php echo $dataInfo['telefono']; ?></strong></li>
